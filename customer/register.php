...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($check->num_rows > 0) {
        ...
        try {
            ...
            $stmt = $conn->prepare("INSERT INTO person (username, password, phone, birth, adress, email, role) VALUES (?, ?, ?, ?, ?, ?, 'customer')");
            ...
            if ($stmt->execute()) {
                ...
                $stmt2 = $conn->prepare("INSERT INTO customer (IDP,username) VALUES (?,?)");
                ...
                if ($stmt2->execute()) {
                    ...
                    throw new Exception("Error creating customer record: " . $stmt2->error);
                }
            } else {
