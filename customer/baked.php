...
$sql = "SELECT name, description FROM section WHERE IDS = 12325";
...
$items = [];
$sqlItems = "SELECT IDT,name, description, price, imgpath FROM items WHERE IDS = 12325";
    ...
    <a href="displayItem.php?id=<?= $item['IDT'] ?>">
      <div class="item">
        ...
        <div class="info">
          ...
          <div class="itemdesc"><span><?= htmlspecialchars($item['description']) ?></span></div>
