...
if (!isset($_SESSION['role']) || $_SESSION['role'] !== 'admin') {
    header("Location: ../customer/loginhtml.php");
}
...
<head>
    ...
    <link rel="stylesheet" href="../customer/stylelogin.css">
</head> 
<body class="back">
    <div class="awning">
        <div class="label">
    ...
    <div class="container">
        <div class="lg">
            <form class="log" method="POST" action="adminreg.php">
        ...
        <?php endif; ?><br>
                ...
                <div>
                 ...
                 <div>
                    ...
                    <input type="text" placeholder="adress" class="adress" value="<?= htmlspecialchars($old_adress) ?>" id="adress" name="adress" >
                </div><br>
                 <div>
                    <label>Phone number</label><br>
                    <input type="number" placeholder="Phone number" class="phone" value="<?= htmlspecialchars($old_phone) ?>" id="phone" name="phone" maxlength="10" required>
                </div><br>
                 <div>
                ...
                <span class="l"><a href="../customer/loginhtml.php">Already have an account?</a></span>
            </form>
        </div>
